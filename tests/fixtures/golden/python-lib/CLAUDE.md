...
- `task build` and `task version` take a package: `task version -- golden-alpha`.
...
- **Archetype:** `python-lib` · **Docs profile:** `mkdocs` · **CI:** GitHub Actions, Sonar on
...
- Python 3.14, `src/` layout per package, pyright strict, ruff for lint and format.
