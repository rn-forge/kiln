...
- A plan: phases, each with steps and an acceptance block that is a command
  plus its expected result. Written to be executed by someone who has not read
...
- A plan states its revision and its decision log, and is superseded rather
  than edited in place once a phase has been executed against it.
