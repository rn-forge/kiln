...
The golden repo for the `python-app` archetype: a complete, runnable repository
whose every generated file is exactly what kiln must render for a single-package
Python application. Its product is one function and one command; everything else
is the standard.
