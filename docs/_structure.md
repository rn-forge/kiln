...
- Areas, in nav order: `architecture/`, `guides/`, `runbooks/` (optional),
  `reference/` (generated), `releases/`, `specs/`, `adr/`, `plans/`.
- `plans/` is this repo's own extension to the seeded model: the record kiln's
  work grew out of — context, reviews, and a frozen plan — not the work
  itself.
...
- Evidence, history, what a review changed → `plans/context.md`.
